...
@allure.title("Negative_TC_IO_006 - Initial Verification of a New Investor without selecting Investor Sub Type")
@allure.description("""
**Test Scenario:**  
Investor Sub Type Mandatory field will be left empty and submitted.
...
def test_site(setup, login_user, click_element, type_into_field, select_dropdown_option, request):
    ...
    with allure.step("Test Passed: No redirection occurred as Investor Sub type was missing"):
        assert "/InvestorProfile" not in driver.current_url, "Unexpected redirection occurred despite missing Investor Sub Type"

# pytest AIF_Investor_Onboarding/Test_IO_006.py --alluredir=allure-results
# allure generate allure-results --clean -o docs
# git add docs
# git commit -m "Updated Allure report"
# git push origin main

# pytest AIF_Investor_Onboarding/Test_IO_006.py --alluredir=allure-results; allure generate allure-results --clean -o docs; git add docs; git commit -m "Updated Allure report"; git push origin main
