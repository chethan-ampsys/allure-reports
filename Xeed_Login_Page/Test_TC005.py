...
@allure.title("TC005 - Login with Empty Email")
@allure.description("""
**Test Scenario:**  
Attempt to log in using empty email  
Username: 
Password: Sk@123
...
# pytest Xeed_Login_Page/Test_TC005.py --alluredir=allure-results; allure generate allure-results --clean -o docs; git add docs; git commit -m "First Commit"; git push origin main
