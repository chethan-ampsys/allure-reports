...
def test_site(setup):
    ...
    with allure.step("Leaving password empty"):
...
# pytest Xeed_Login_Page/Test_TC006.py --alluredir=allure-results; allure generate allure-results --clean -o docs; git add docs; git commit -m "First Commit"; git push origin main
